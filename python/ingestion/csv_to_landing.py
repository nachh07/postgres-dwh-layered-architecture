...
from python.config.settings import DATA_DIR, CSV_TABLE_MAPPING, SPECIAL_DELIMITERS
...
TABLE_COLUMNS = {
    'raw_clientes': ['id', 'provincia', 'nombre_y_apellido', 'domicilio', 'telefono', 'edad', 'localidad', 'x', 'y', 'fecha_alta', 'usuario_alta', 'fecha_ultima_modificacion', 'usuario_ultima_modificacion', 'marca_baja', 'col10'],
    'raw_ventas': ['idventa', 'fecha', 'fecha_entrega', 'idcanal', 'idcliente', 'idsucursal', 'idempleado', 'idproducto', 'precio', 'cantidad'],
    ...
    'raw_empleados': ['id_empleado', 'apellido', 'nombre', 'sucursal', 'sector', 'cargo', 'salario'],
    'raw_sucursales': ['id', 'sucursal', 'direccion', 'localidad', 'provincia', 'latitud', 'longitud'],
    'raw_proveedores': ['idproveedor', 'nombre', 'address', 'city', 'state', 'country', 'departamen'],
