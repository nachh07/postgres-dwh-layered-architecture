...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--create-schema", action="store_true", help="Crear schemas antes de ejecutar"
    )
    parser.add_argument(
        "--create-tables", action="store_true", help="Crear tablas antes de ejecutar"
    )

    args = parser.parse_args()

    success = run_full_pipeline(create_schema=args.create_schema, create_tables=args.create_tables)
